...
curl -O https://srtm.csi.cgiar.org/wp-content/uploads/files/srtm_5x5/TIFF/srtm_36_03.zip
...
if [[ "$choice" =~ [yY] ]]; then
  rm -f readme.txt
  rm -f srtm_36_03.hdr srtm_36_03.tfw srtm_36_03.zip
  rm -f srtm_38_02.hdr srtm_38_02.tfw srtm_38_02.zip
  rm -f srtm_38_03.hdr srtm_38_03.tfw srtm_38_03.zip
fi
